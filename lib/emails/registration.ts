export function registrationEmailHtml(magicLink: string): string {
  return /* html */`
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Complete your flyteLog registration</title>
</head>
          ...
          <tr>
            <td style="background-color:#18181b;border:1px solid #27272a;border-radius:20px;padding:40px 36px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <div style="background-color:#0ea5e915;border:1px solid #0ea5e930;border-radius:50%;width:64px;height:64px;display:inline-block;text-align:center;line-height:64px;font-size:30px;">✉️</div>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#71717a;text-align:center;line-height:1.6;">
                Click the button below to finish creating your flyteLog account.<br />
                This link is valid for <strong style="color:#a1a1aa;">24 hours</strong>.
              </p>
              ...
              <p style="margin:20px 0 0;font-size:12px;color:#52525b;text-align:center;line-height:1.7;">
                ...
                <span style="color:#0ea5e9;word-break:break-all;">${magicLink}</span>
              </p>
          ...
          <tr>
            <td align="center" style="padding-top:24px;">
              <p style="margin:0;font-size:12px;color:#3f3f46;line-height:1.6;">
                You're receiving this because someone used this email to register on flyteLog.<br />
...
export const registrationEmailSubject = () => 'Complete your flyteLog registration';
